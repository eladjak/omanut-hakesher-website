...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "סודיות היא ערך עליון. כל מה שנאמר במפגשים נשאר חסוי לחלוטין, בהתאם לכללי האתיקה המקצועיים. אני מחויב לחיסיון מוחלט, ולא אשתף מידע עם גורם שלישי ללא הסכמתכם המפורשת (למעט מקרים חריגים המוגדרים בחוק).",
  },
  {
