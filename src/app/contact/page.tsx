        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="lg:ps-8">
              <h2 className="text-2xl font-bold mb-6">דרכים נוספות ליצירת קשר</h2>
              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">וואטסאפ</h3>
                    <a
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:hello@omanut-hakesher.co.il"
                      className="text-muted-foreground hover:text-primary"
                      dir="ltr"
                    >
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">רשתות חברתיות</h3>
                    <div className="flex gap-4">
                      <a
