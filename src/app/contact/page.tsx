      ...
      <section className="py-24 bg-gradient-to-b from-muted to-background">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            נשמח לענות על כל שאלה ולעזור לכם להתחיל את המסע לקשר טוב יותר
          </p>
        </div>
      </section>
            ...
            <div className="lg:col-span-3">
              <Card className="border-border/50">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground mb-8">מלאו את הטופס ונחזור אליכם בהקדם</p>
                  <ContactForm />
                </CardContent>
              </Card>
            </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card className="border-border/50">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-5">
                    {/* Phone */}
                    <a href="tel:+972501234567" className="flex items-center gap-4 group">
                      ...
                      <div>
                        ...
                        <p className="font-medium group-hover:text-primary transition-colors" dir="ltr">050-123-4567</p>
                      </div>
                    </a>
                    ...
                    {/* WhatsApp */}
                    <a href="https://wa.me/972501234567" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group">
                      ...
                      <div>
                        ...
                        <p className="font-medium group-hover:text-primary transition-colors">שלחו הודעה</p>
                      </div>
                    </a>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-sm text-muted-foreground">רשתות חברתיות</p>
                        <div className="flex gap-3">
                          <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-sm font-medium hover:text-primary transition-colors">
                            אינסטגרם
                          </a>
                          <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-sm font-medium hover:text-primary transition-colors">
                            פייסבוק
                          </a>
                        </div>
                      </div>
              ...
              <Card className="border-accent/30 bg-gradient-to-br from-accent/5 to-background">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="font-bold mb-2">הזמנת פגישה</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    בקרוב תוכלו לקבוע פגישת היכרות ישירות מהאתר
                  </p>
