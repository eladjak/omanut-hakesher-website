...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      // Lead-magnet delivery (2026-07-09): lead-magnets.ts promises
      // /lead/<slug>/download — serve the static PDFs from public/downloads/.
      // Generated by scripts/lead-pdfs/render.mjs. NOTE: 23-reasons,
      // 7-principles and 36-questions still have no PDF asset — add their
      // redirect here once the file lands in public/downloads/.
      { source: "/lead/courage/download", destination: "/downloads/courage.pdf", permanent: false },
      { source: "/lead/vision/download", destination: "/downloads/vision.pdf", permanent: false },
      { source: "/lead/dating-talks/download", destination: "/downloads/dating-talks.pdf", permanent: false },
